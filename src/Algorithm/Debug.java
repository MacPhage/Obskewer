...
catch (Exception e)
{
  ...
  {
    JOptionPane.showMessageDialog(null,e.getStackTrace(),"Obskewer Error",JOptionPane.ERROR_MESSAGE);
  }
}
...
public class Debug
{
  ...
  public static void setDefault()
  {
    ...
    try
    {
      output = new FileOutputStream(projectName+".properties");
  ...
  public static boolean displayDebug()
  {
    Properties prop = new Properties();
	  ...
	  try
    {
  		input = new FileInputStream(projectName+".properties");
  		prop.load(input);
