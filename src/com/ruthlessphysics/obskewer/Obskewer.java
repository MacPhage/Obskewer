...
public class Obskewer
{
	...
	static String version = "1.2.3, last updated August 5, 2014";
	static String changes = "- Added TrueCaesar cipher support\n"+
			...
			"Patch #3:\n- Added Piglatin cipher support";

	public static void main(String args[])
	{
		if(System.getProperty("os.name").contains("Windows") && false)
		{
			System.out.println("os.name ("+System.getProperty("os.name")+") contains \'Windows\'.");
			JFrame obskewer = new JFrame(projectName);
			obskewer.setVisible(true);
		}
		boolean debug = false;
		String operation;
		while(true)
	...
	public static void doEncode()
	{
		String in = JOptionPane.showInputDialog(null,"Encoding to a Cipher...\n"+
				"Ciphers: \'ClassicShift\', \'TrueCaesar\', \'Morse\', \'Numbers\', \'Piglatin\', \'(none)\'\nType your cipher type of choice: ",
				"TrueCaesar");
		...
		else if(in.equals("Piglatin"))
		{
			Piglatin.performEncode();
		}
		/*
	...
	public static void showInfo()
	{
		JOptionPane.showMessageDialog(null,
				"Obskewer is a light-weight Java application for encoding and decoding text.\n"+
						...
						"Official website: http://github.com/MacPhage/Obskewer\n"+
